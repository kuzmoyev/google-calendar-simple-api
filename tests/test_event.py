...
from event import Event, Visibility
from recurrence import Recurrence, DAILY, SU, SA, MONDAY
...
class TestEvent(TestCase):
    ...
    def test_init_no_end(self):
        start = 1 / Jun / 2019
        event = Event('Good day', start)
        self.assertEqual(event.end, start + 1 * days)

        start = (1 / Jul / 2019)[12:00]
        event = Event('Lunch', start)
        self.assertEqual(event.end, start + 1 * hours)

    def test_init_different_date_types(self):
        with self.assertRaises(TypeError):
            Event('Good day', start=(1 / Jan / 2019), end=(2 / Jan / 2019)[5:55])

    def test_add_attachment(self):
        e = Event('Good day', start=(1 / Aug / 2019))
    ...
    def test_add_reminders(self):
        e = Event('Good day', start=(28 / Mar / 2019))
...
class TestEventSerializer(TestCase):
    def test_to_json(self):
        e = Event('Good day', start=(28 / Sept / 2019))
        event_json = {
            'summary': 'Good day',
        ...
        e = Event('Good day', start=(28 / Oct / 2019)[11:22:33])
        event_json = {
            'summary': 'Good day',
            'start': {'dateTime': '2019-10-28T11:22:33'},
            'end': {'dateTime': '2019-10-28T12:22:33'},
            'recurrence': [],
            'visibility': 'default',
            'reminders': {'useDefault': True, 'overrides': []},
            'attachments': []
    ...
    def test_to_json_recurrence(self):
        ...
        event_json = {
            'summary': 'Good day',
            'start': {'dateTime': '2019-01-01T11:22:33'},
            'end': {'dateTime': '2020-01-01T11:22:33'},
            'recurrence': [
    ...
    def test_to_json_attachments(self):
        ...
        event_json = {
            'summary': 'Good day',
            'start': {'dateTime': '2019-01-01T11:22:33'},
            'end': {'dateTime': '2019-01-01T12:22:33'},
            'recurrence': [],
            'visibility': 'default',
            'reminders': {'useDefault': True, 'overrides': []},
            'attachments': [
